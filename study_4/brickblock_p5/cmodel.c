...
void run_model(void) {
  ...
  while (sol_continue()) {
    ...
    case 3: {
      ...
      sol_uint256_t prev = Read_Map_1(&contract_0.user_balances, contract_0.model_address);
      BrickblockToken_Method_distributeTokens(&(contract_0), sender, value,
                                              blocknum, timestamp, paid, sender,
                                              arg__contributor, arg__value);
      sol_uint256_t curr = Read_Map_1(&contract_0.user_balances, contract_0.model_address);
