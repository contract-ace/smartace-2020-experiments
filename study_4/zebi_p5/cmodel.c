...
void run_model(void) {
  ...
  while (sol_continue()) {
    ...
    if (sol_is_using_reps()) {
      ...
      (((contract_0).user_allowed).data_0_6) =
      ...
      (((contract_0).user_allowed).data_1_6) =
      ...
      (((contract_0).user_allowed).data_2_6) =
      ...
      (((contract_0).user_allowed).data_3_6) =
      ...
      (((contract_0).user_allowed).data_4_6) =
      ...
      (((contract_0).user_balances).data_6) =
    ...
    sol_uint256_t last_bal = contract_0.user_balances.data_6;
    switch (next_call) {
    case 0: {
    ...
    if (contract_0.user_transferAllowed.v == 0 && last_sender.v != contract_0.user_owner.v) {
      sol_assert(contract_0.user_balances.data_6.v == last_bal.v, "Property.");
    }
  }
}