...
void run_model(void) {
  ...
  while (sol_continue()) {
    ...
    sol_bool_t implicit_constaint_1 = Read_Map_3(&contract_0.user___minters.user_bearer, IMPLICIT_1);
    contract_0.user___minters.user_bearer = ND_Map_3();
    Write_Map_3(&contract_0.user___minters.user_bearer, IMPLICIT_1, implicit_constaint_1);
    switch (next_call) {
    case 0: {
    ...
    sol_bool_t next = Read_Map_3(&contract_0.user___minters.user_bearer, IMPLICIT_1);
    if (implicit_constaint_1.v == 1 && next.v == 0)
    {
      sol_assert(curr_sender.v == IMPLICIT_1.v, 0);
    }
  }
}