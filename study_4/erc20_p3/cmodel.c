...
struct Map_3 ND_Map_3(void) {
  struct Map_3 tmp;
  ((tmp).sum) = (Init_sol_bool_t(GET_ND_RANGE(0, 0, 2, "Map_3:model_sum")));
  ((tmp).data_0) = (Init_sol_bool_t(GET_ND_RANGE(1, 0, 2, "Map_3:data_0")));
  ((tmp).data_1) = (Init_sol_bool_t(GET_ND_RANGE(2, 0, 2, "Map_3:data_1")));
  ((tmp).data_2) = (Init_sol_bool_t(GET_ND_RANGE(3, 0, 2, "Map_3:data_2")));
  ((tmp).data_3) = (Init_sol_bool_t(GET_ND_RANGE(4, 0, 2, "Map_3:data_3")));
  ((tmp).data_4) = (Init_sol_bool_t(GET_ND_RANGE(5, 0, 2, "Map_3:data_4")));
  return tmp;
}
sol_bool_t Read_Map_3(struct Map_3 *arr, sol_address_t key_0) {
  {
...
struct Map_1 ND_Map_1(void) {
  struct Map_1 tmp;
  ((tmp).sum) = (Init_sol_uint256_t(GET_ND_UINT(6, 256, "Map_1:model_sum")));
  ((tmp).data_0) = (Init_sol_uint256_t(GET_ND_UINT(7, 256, "Map_1:data_0")));
  ((tmp).data_1) = (Init_sol_uint256_t(GET_ND_UINT(8, 256, "Map_1:data_1")));
  ((tmp).data_2) = (Init_sol_uint256_t(GET_ND_UINT(9, 256, "Map_1:data_2")));
  ((tmp).data_3) = (Init_sol_uint256_t(GET_ND_UINT(10, 256, "Map_1:data_3")));
  ((tmp).data_4) = (Init_sol_uint256_t(GET_ND_UINT(11, 256, "Map_1:data_4")));
  return tmp;
}
sol_uint256_t Read_Map_1(struct Map_1 *arr, sol_address_t key_0) {
  {
...
struct Map_2 ND_Map_2(void) {
  struct Map_2 tmp;
  ((tmp).sum) = (Init_sol_uint256_t(GET_ND_UINT(12, 256, "Map_2:model_sum")));
  ((tmp).data_0_0) =
      (Init_sol_uint256_t(GET_ND_UINT(13, 256, "Map_2:data_0_0")));
  ((tmp).data_0_1) =
      (Init_sol_uint256_t(GET_ND_UINT(14, 256, "Map_2:data_0_1")));
  ((tmp).data_0_2) =
      (Init_sol_uint256_t(GET_ND_UINT(15, 256, "Map_2:data_0_2")));
  ((tmp).data_0_3) =
      (Init_sol_uint256_t(GET_ND_UINT(16, 256, "Map_2:data_0_3")));
  ((tmp).data_0_4) =
      (Init_sol_uint256_t(GET_ND_UINT(17, 256, "Map_2:data_0_4")));
  ((tmp).data_1_0) =
  ...
  ((tmp).data_4_0) =
      (Init_sol_uint256_t(GET_ND_UINT(33, 256, "Map_2:data_4_0")));
  ((tmp).data_4_1) =
      (Init_sol_uint256_t(GET_ND_UINT(34, 256, "Map_2:data_4_1")));
  ((tmp).data_4_2) =
      (Init_sol_uint256_t(GET_ND_UINT(35, 256, "Map_2:data_4_2")));
  ((tmp).data_4_3) =
      (Init_sol_uint256_t(GET_ND_UINT(36, 256, "Map_2:data_4_3")));
  ((tmp).data_4_4) =
      (Init_sol_uint256_t(GET_ND_UINT(37, 256, "Map_2:data_4_4")));
  return tmp;
}
sol_uint256_t Read_Map_2(struct Map_2 *arr, sol_address_t key_0,
                         sol_address_t key_1) {
...
void ND_Token(struct Token *self) {
  ((self)->model_balance) =
      (Init_sol_uint256_t(GET_ND_UINT(38, 256, "Token:model_balance")));
  ((self)->user___minters) = (ND_Roles_Struct_Role());
  ((self)->user___name) =
      (Init_sol_uint256_t(GET_ND_UINT(39, 256, "Token:_name")));
  ((self)->user___symbol) =
      (Init_sol_uint256_t(GET_ND_UINT(40, 256, "Token:_symbol")));
  ((self)->user___decimals) =
      (Init_sol_uint8_t(GET_ND_UINT(41, 8, "Token:_decimals")));
  ((self)->user___balances) = (ND_Map_1());
  ((self)->user___allowances) = (ND_Map_2());
  ((self)->user___totalSupply) =
      (Init_sol_uint256_t(GET_ND_UINT(42, 256, "Token:_totalSupply")));
}
...
void run_model(void) {
  sol_uint256_t blocknum;
  ((blocknum).v) = (GET_ND_UINT(76, 256, "blocknum"));
  sol_uint256_t timestamp;
  ((timestamp).v) = (GET_ND_UINT(77, 256, "timestamp"));
  sol_bool_t paid;
  ((paid).v) = (1);
  ...
  if (GET_ND_RANGE(80, 0, 2, "take_step")) {
    ((blocknum).v) = (GET_ND_INCREASE(78, (blocknum).v, 1, "blocknum"));
    ((timestamp).v) = (GET_ND_INCREASE(79, (timestamp).v, 1, "timestamp"));
  }
  {
    sol_address_t sender;
    ((sender).v) = (GET_ND_RANGE(81, 2, 5, "sender"));
    sol_uint256_t value;
    ((value).v) = (0);
  ...
  while (sol_continue()) {
    ...
    sol_assert(
        contract_0.user___balances.sum.v == contract_0.user___totalSupply.v, 0);
    if (GET_ND_RANGE(84, 0, 2, "take_step")) {
      ((blocknum).v) = (GET_ND_INCREASE(82, (blocknum).v, 1, "blocknum"));
      ((timestamp).v) = (GET_ND_INCREASE(83, (timestamp).v, 1, "timestamp"));
    }
    uint8_t next_call;
    (next_call) = (GET_ND_RANGE(85, 0, 15, "next_call"));
    switch (next_call) {
    case 0: {
      ...
      sol_uint256_t arg_amount =
          Init_sol_uint256_t(GET_ND_UINT(45, 256, "amount"));
    ...
    case 1: {
      ...
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(46, 2, 5, "sender"));
      sol_uint256_t value;
      ((value).v) = (0);
      sol_address_t arg_account =
          Init_sol_address_t(GET_ND_RANGE(47, 0, 5, "account"));
    ...
    case 2: {
      ...
      ((value).v) = (0);
      sol_address_t arg_account =
          Init_sol_address_t(GET_ND_RANGE(49, 0, 5, "account"));
    ...
    case 6: {
      ...
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(53, 2, 5, "sender"));
      sol_uint256_t value;
      ((value).v) = (0);
    ...
    case 8: {
      ...
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(55, 2, 5, "sender"));
      sol_uint256_t value;
      ((value).v) = (0);
      sol_address_t arg_account =
          Init_sol_address_t(GET_ND_RANGE(56, 0, 5, "account"));
    ...
    case 9: {
      ...
      sol_address_t arg_recipient =
          Init_sol_address_t(GET_ND_RANGE(58, 0, 5, "recipient"));
      sol_uint256_t arg_amount =
          Init_sol_uint256_t(GET_ND_UINT(59, 256, "amount"));
    ...
    case 10: {
      ...
      sol_address_t arg_owner =
          Init_sol_address_t(GET_ND_RANGE(61, 0, 5, "owner"));
      sol_address_t arg_spender =
          Init_sol_address_t(GET_ND_RANGE(62, 0, 5, "spender"));
    ...
    case 11: {
      ...
      ((value).v) = (0);
      sol_address_t arg_spender =
          Init_sol_address_t(GET_ND_RANGE(64, 0, 5, "spender"));
      sol_uint256_t arg_value =
          Init_sol_uint256_t(GET_ND_UINT(65, 256, "value"));
    ...
    case 12: {
      ...
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(66, 2, 5, "sender"));
      sol_uint256_t value;
      ((value).v) = (0);
      sol_address_t arg_sender =
          Init_sol_address_t(GET_ND_RANGE(67, 0, 5, "sender"));
      sol_address_t arg_recipient =
          Init_sol_address_t(GET_ND_RANGE(68, 0, 5, "recipient"));
      sol_uint256_t arg_amount =
    ...
    case 13: {
      ...
      sol_uint256_t arg_addedValue =
          Init_sol_uint256_t(GET_ND_UINT(72, 256, "addedValue"));
    ...
    case 14: {
      smartace_log("[Calling decreaseAllowance(spender, subtractedValue) on "
                   "contract_0]");
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(73, 2, 5, "sender"));
      sol_uint256_t value;
      ((value).v) = (0);
      sol_address_t arg_spender =
          Init_sol_address_t(GET_ND_RANGE(74, 0, 5, "spender"));
      sol_uint256_t arg_subtractedValue =
          Init_sol_uint256_t(GET_ND_UINT(75, 256, "subtractedValue"));
