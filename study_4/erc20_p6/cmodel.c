...
void run_model(void) {
  ...
  while (sol_continue()) {
    ...
    case 12: {
      ...
      sol_uint256_t last_sender_bal = Read_Map_1(&contract_0.user___balances, arg_sender);
      sol_uint256_t last_recip_bal = Read_Map_1(&contract_0.user___balances, arg_recipient);
      sol_uint256_t last_allowed = Read_Map_2(&contract_0.user___allowances, arg_sender, sender);
      ERC20_Method_For_Token_transferFrom(
          &(contract_0), sender, value, blocknum, timestamp, paid, sender,
          arg_sender, arg_recipient, arg_amount);
      sol_uint256_t curr_sender_bal = Read_Map_1(&contract_0.user___balances, arg_sender);
      sol_uint256_t curr_recip_bal = Read_Map_1(&contract_0.user___balances, arg_recipient);
      sol_uint256_t curr_allowed = Read_Map_2(&contract_0.user___allowances, arg_sender, sender);
