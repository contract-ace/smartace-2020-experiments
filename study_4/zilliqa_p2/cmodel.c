...
struct Map_2 ND_Map_2(void) {
  struct Map_2 tmp;
  ((tmp).sum) = (Init_sol_uint256_t(GET_ND_UINT(0, 256, "Map_2:model_sum")));
  ((tmp).data_0_0) =
      (Init_sol_uint256_t(GET_ND_UINT(1, 256, "Map_2:data_0_0")));
  ((tmp).data_0_1) =
      (Init_sol_uint256_t(GET_ND_UINT(2, 256, "Map_2:data_0_1")));
  ((tmp).data_0_2) =
      (Init_sol_uint256_t(GET_ND_UINT(3, 256, "Map_2:data_0_2")));
  ((tmp).data_0_3) =
      (Init_sol_uint256_t(GET_ND_UINT(4, 256, "Map_2:data_0_3")));
  ((tmp).data_0_4) =
      (Init_sol_uint256_t(GET_ND_UINT(5, 256, "Map_2:data_0_4")));
  ((tmp).data_0_5) =
      (Init_sol_uint256_t(GET_ND_UINT(6, 256, "Map_2:data_0_5")));
  ((tmp).data_0_6) =
      (Init_sol_uint256_t(GET_ND_UINT(7, 256, "Map_2:data_0_6")));
  ((tmp).data_1_0) =
      (Init_sol_uint256_t(GET_ND_UINT(8, 256, "Map_2:data_1_0")));
  ((tmp).data_1_1) =
      (Init_sol_uint256_t(GET_ND_UINT(9, 256, "Map_2:data_1_1")));
  ((tmp).data_1_2) =
      (Init_sol_uint256_t(GET_ND_UINT(10, 256, "Map_2:data_1_2")));
  ((tmp).data_1_3) =
      (Init_sol_uint256_t(GET_ND_UINT(11, 256, "Map_2:data_1_3")));
  ((tmp).data_1_4) =
      (Init_sol_uint256_t(GET_ND_UINT(12, 256, "Map_2:data_1_4")));
  ((tmp).data_1_5) =
      (Init_sol_uint256_t(GET_ND_UINT(13, 256, "Map_2:data_1_5")));
  ((tmp).data_1_6) =
      (Init_sol_uint256_t(GET_ND_UINT(14, 256, "Map_2:data_1_6")));
  ((tmp).data_2_0) =
      (Init_sol_uint256_t(GET_ND_UINT(15, 256, "Map_2:data_2_0")));
  ((tmp).data_2_1) =
      (Init_sol_uint256_t(GET_ND_UINT(16, 256, "Map_2:data_2_1")));
  ((tmp).data_2_2) =
      (Init_sol_uint256_t(GET_ND_UINT(17, 256, "Map_2:data_2_2")));
  ((tmp).data_2_3) =
      (Init_sol_uint256_t(GET_ND_UINT(18, 256, "Map_2:data_2_3")));
  ((tmp).data_2_4) =
      (Init_sol_uint256_t(GET_ND_UINT(19, 256, "Map_2:data_2_4")));
  ((tmp).data_2_5) =
      (Init_sol_uint256_t(GET_ND_UINT(20, 256, "Map_2:data_2_5")));
  ((tmp).data_2_6) =
      (Init_sol_uint256_t(GET_ND_UINT(21, 256, "Map_2:data_2_6")));
  ((tmp).data_3_0) =
      (Init_sol_uint256_t(GET_ND_UINT(22, 256, "Map_2:data_3_0")));
  ((tmp).data_3_1) =
      (Init_sol_uint256_t(GET_ND_UINT(23, 256, "Map_2:data_3_1")));
  ((tmp).data_3_2) =
      (Init_sol_uint256_t(GET_ND_UINT(24, 256, "Map_2:data_3_2")));
  ((tmp).data_3_3) =
      (Init_sol_uint256_t(GET_ND_UINT(25, 256, "Map_2:data_3_3")));
  ((tmp).data_3_4) =
      (Init_sol_uint256_t(GET_ND_UINT(26, 256, "Map_2:data_3_4")));
  ((tmp).data_3_5) =
      (Init_sol_uint256_t(GET_ND_UINT(27, 256, "Map_2:data_3_5")));
  ((tmp).data_3_6) =
      (Init_sol_uint256_t(GET_ND_UINT(28, 256, "Map_2:data_3_6")));
  ((tmp).data_4_0) =
      (Init_sol_uint256_t(GET_ND_UINT(29, 256, "Map_2:data_4_0")));
  ((tmp).data_4_1) =
      (Init_sol_uint256_t(GET_ND_UINT(30, 256, "Map_2:data_4_1")));
  ((tmp).data_4_2) =
      (Init_sol_uint256_t(GET_ND_UINT(31, 256, "Map_2:data_4_2")));
  ((tmp).data_4_3) =
      (Init_sol_uint256_t(GET_ND_UINT(32, 256, "Map_2:data_4_3")));
  ((tmp).data_4_4) =
      (Init_sol_uint256_t(GET_ND_UINT(33, 256, "Map_2:data_4_4")));
  ((tmp).data_4_5) =
      (Init_sol_uint256_t(GET_ND_UINT(34, 256, "Map_2:data_4_5")));
  ((tmp).data_4_6) =
      (Init_sol_uint256_t(GET_ND_UINT(35, 256, "Map_2:data_4_6")));
  ((tmp).data_5_0) =
      (Init_sol_uint256_t(GET_ND_UINT(36, 256, "Map_2:data_5_0")));
  ((tmp).data_5_1) =
      (Init_sol_uint256_t(GET_ND_UINT(37, 256, "Map_2:data_5_1")));
  ((tmp).data_5_2) =
      (Init_sol_uint256_t(GET_ND_UINT(38, 256, "Map_2:data_5_2")));
  ((tmp).data_5_3) =
      (Init_sol_uint256_t(GET_ND_UINT(39, 256, "Map_2:data_5_3")));
  ((tmp).data_5_4) =
      (Init_sol_uint256_t(GET_ND_UINT(40, 256, "Map_2:data_5_4")));
  ((tmp).data_5_5) =
      (Init_sol_uint256_t(GET_ND_UINT(41, 256, "Map_2:data_5_5")));
  ((tmp).data_5_6) =
      (Init_sol_uint256_t(GET_ND_UINT(42, 256, "Map_2:data_5_6")));
  ((tmp).data_6_0) =
      (Init_sol_uint256_t(GET_ND_UINT(43, 256, "Map_2:data_6_0")));
  ((tmp).data_6_1) =
      (Init_sol_uint256_t(GET_ND_UINT(44, 256, "Map_2:data_6_1")));
  ((tmp).data_6_2) =
      (Init_sol_uint256_t(GET_ND_UINT(45, 256, "Map_2:data_6_2")));
  ((tmp).data_6_3) =
      (Init_sol_uint256_t(GET_ND_UINT(46, 256, "Map_2:data_6_3")));
  ((tmp).data_6_4) =
      (Init_sol_uint256_t(GET_ND_UINT(47, 256, "Map_2:data_6_4")));
  ((tmp).data_6_5) =
      (Init_sol_uint256_t(GET_ND_UINT(48, 256, "Map_2:data_6_5")));
  ((tmp).data_6_6) =
      (Init_sol_uint256_t(GET_ND_UINT(49, 256, "Map_2:data_6_6")));
  return tmp;
}
sol_uint256_t Read_Map_2(struct Map_2 *arr, sol_address_t key_0,
                         sol_address_t key_1) {
...
struct Map_1 ND_Map_1(void) {
  struct Map_1 tmp;
  ((tmp).sum) = (Init_sol_uint256_t(GET_ND_UINT(50, 256, "Map_1:model_sum")));
  ((tmp).data_0) = (Init_sol_uint256_t(GET_ND_UINT(51, 256, "Map_1:data_0")));
  ((tmp).data_1) = (Init_sol_uint256_t(GET_ND_UINT(52, 256, "Map_1:data_1")));
  ((tmp).data_2) = (Init_sol_uint256_t(GET_ND_UINT(53, 256, "Map_1:data_2")));
  ((tmp).data_3) = (Init_sol_uint256_t(GET_ND_UINT(54, 256, "Map_1:data_3")));
  ((tmp).data_4) = (Init_sol_uint256_t(GET_ND_UINT(55, 256, "Map_1:data_4")));
  ((tmp).data_5) = (Init_sol_uint256_t(GET_ND_UINT(56, 256, "Map_1:data_5")));
  ((tmp).data_6) = (Init_sol_uint256_t(GET_ND_UINT(57, 256, "Map_1:data_6")));
  return tmp;
}
sol_uint256_t Read_Map_1(struct Map_1 *arr, sol_address_t key_0) {
  {
...
void ND_ZilliqaToken(struct ZilliqaToken *self) {
  ((self)->model_balance) =
      (Init_sol_uint256_t(GET_ND_UINT(58, 256, "ZilliqaToken:model_balance")));
  ((self)->user_pausedPublic) =
      (Init_sol_bool_t(GET_ND_RANGE(59, 0, 2, "ZilliqaToken:pausedPublic")));
  ((self)->user_pausedOwnerAdmin) = (Init_sol_bool_t(
      GET_ND_RANGE(60, 0, 2, "ZilliqaToken:pausedOwnerAdmin")));
  ((self)->user_admin) =
      (Init_sol_address_t(GET_ND_RANGE(61, 0, 7, "ZilliqaToken:admin")));
  ((self)->user_owner) =
      (Init_sol_address_t(GET_ND_RANGE(62, 0, 7, "ZilliqaToken:owner")));
  ((self)->user_allowed) = (ND_Map_2());
  ((self)->user_balances) = (ND_Map_1());
  ((self)->user_totalSupply) =
      (Init_sol_uint256_t(GET_ND_UINT(63, 256, "ZilliqaToken:totalSupply")));
}
...
void run_model(void) {
  sol_uint256_t blocknum;
  ((blocknum).v) = (GET_ND_UINT(97, 256, "blocknum"));
  sol_uint256_t timestamp;
  ((timestamp).v) = (GET_ND_UINT(98, 256, "timestamp"));
  sol_bool_t paid;
  ((paid).v) = (1);
  ...
  if (GET_ND_RANGE(101, 0, 2, "take_step")) {
    ((blocknum).v) = (GET_ND_INCREASE(99, (blocknum).v, 1, "blocknum"));
    ((timestamp).v) = (GET_ND_INCREASE(100, (timestamp).v, 1, "timestamp"));
  }
  {
    sol_address_t sender;
    ((sender).v) = (GET_ND_RANGE(102, 2, 7, "sender"));
    sol_uint256_t value;
    ((value).v) = (0);
    Init_ZilliqaToken(
        &(contract_0), sender, value, blocknum, timestamp, paid, sender,
        Init_sol_address_t(GET_ND_RANGE(103, 0, 7, "ZilliqaToken:_admin")),
        Init_sol_uint256_t(
            GET_ND_UINT(104, 256, "ZilliqaToken:_totalTokenAmount")));
  }
  ...
  while (sol_continue()) {
    ...
    uint8_t next_call;
    (next_call) = (GET_ND_RANGE(108, 0, 12, "next_call"));
    sol_uint256_t sum = contract_0.user_balances.sum;
    sol_assert(contract_0.user_balances.sum.v == contract_0.user_totalSupply.v, 0);
    contract_0.user_balances = ND_Map_1();
    contract_0.user_balances.sum = sum;
    contract_0.user_allowed = ND_Map_2();
    switch (next_call) {
    case 0: {
      smartace_log("[Calling transfer(_to, _value) on contract_0]");
      sol_address_t sender;
      ((sender).v) = (GET_ND_RANGE(64, 2, 7, "sender"));
      sol_uint256_t value;
      ((value).v) = (0);
      sol_address_t arg__to = Init_sol_address_t(GET_ND_RANGE(65, 0, 7, "_to"));
      sol_uint256_t arg__value =
          Init_sol_uint256_t(GET_ND_UINT(66, 256, "_value"));
    ...
    case 1: {
      ...
      sol_address_t arg__from =
          Init_sol_address_t(GET_ND_RANGE(68, 0, 7, "_from"));
      sol_address_t arg__to = Init_sol_address_t(GET_ND_RANGE(69, 0, 7, "_to"));
      sol_uint256_t arg__value =
    ...
    case 3: {
      ...
      ((value).v) = (0);
      sol_address_t arg__from =
          Init_sol_address_t(GET_ND_RANGE(74, 0, 7, "_from"));
      sol_uint256_t arg__value =
          Init_sol_uint256_t(GET_ND_UINT(75, 256, "_value"));
    ...
    case 4: {
      ...
      sol_address_t arg_newAdmin =
          Init_sol_address_t(GET_ND_RANGE(77, 0, 7, "newAdmin"));
    ...
    case 5: {
      ...
      sol_address_t arg__spender =
          Init_sol_address_t(GET_ND_RANGE(79, 0, 7, "_spender"));
      sol_uint256_t arg__value =
          Init_sol_uint256_t(GET_ND_UINT(80, 256, "_value"));
    ...
    case 6: {
      ...
      ((value).v) = (0);
      sol_address_t arg__spender =
          Init_sol_address_t(GET_ND_RANGE(82, 0, 7, "_spender"));
      sol_uint256_t arg__addedValue =
          Init_sol_uint256_t(GET_ND_UINT(83, 256, "_addedValue"));
    ...
    case 7: {
      ...
      ((value).v) = (0);
      sol_address_t arg__spender =
          Init_sol_address_t(GET_ND_RANGE(85, 0, 7, "_spender"));
      sol_uint256_t arg__subtractedValue =
          Init_sol_uint256_t(GET_ND_UINT(86, 256, "_subtractedValue"));
    ...
    case 8: {
      ...
      sol_bool_t arg_newPausedPublic =
          Init_sol_bool_t(GET_ND_RANGE(88, 0, 2, "newPausedPublic"));
      sol_bool_t arg_newPausedOwnerAdmin =
          Init_sol_bool_t(GET_ND_RANGE(89, 0, 2, "newPausedOwnerAdmin"));
    ...
    case 10: {
      ...
      sol_address_t arg__owner =
          Init_sol_address_t(GET_ND_RANGE(93, 0, 7, "_owner"));
      sol_address_t arg__spender =
          Init_sol_address_t(GET_ND_RANGE(94, 0, 7, "_spender"));
    ...
    case 11: {
      ...
      ((value).v) = (0);
      sol_address_t arg__owner =
          Init_sol_address_t(GET_ND_RANGE(96, 0, 7, "_owner"));
