...
void run_model(void) {
  ...
  while (sol_continue()) {
    ...
    prev_nextMinting = contract_0.user_nextMinting;
    ...
    if (prev_nextMinting.v != contract_0.user_nextMinting.v)
    {
      sol_assert(prev_nextMinting.v == contract_0.user_nextMinting.v - 31536000, 0);
    }
  }
}